...
"""
Benchmark network with 2 compartment groups of size 100 with dense connection along with \
register and synapse probes
"""
...
class CompartmentGroupsWithRegisterAndSynapseProbesSuite(PerfLoggingHandler):
    """Benchmark network with 2 compartment groups of size 100 with dense connection along with \
    register and synapse probes"""
...
if __name__ == '__main__':
    CompartmentGroupsWithRegisterAndSynapseProbesSuite().time_workload()
