...
"""
Benchmark network with 2 compartment groups of size 100 with dense connection without any probes
"""
...
class CompartmentGroupsWithoutProbesSuite(PerfLoggingHandler):
    """Benchmark network with 2 compartment groups of size 100 with dense connection without any probes"""
...
if __name__ == '__main__':
    CompartmentGroupsWithoutProbesSuite().time_workload()
