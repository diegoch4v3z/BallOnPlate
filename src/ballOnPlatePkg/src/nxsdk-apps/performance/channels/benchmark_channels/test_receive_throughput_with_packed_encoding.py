...
"""Benchmarking recv throughput on superhost with packed encoding"""
...
class ReceiveThroughputWithPackedEncodingSuite(ChannelThroughputBenchmark):
    """Receives packed data to measure recv throughput via channel"""
    @timeit
...
if __name__ == '__main__':
    ...
    ReceiveThroughputWithPackedEncodingSuite().benchmarkChannels(
