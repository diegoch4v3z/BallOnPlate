...
"""Benchmarking send throughput on superhost with raw encoding"""
...
class SendThroughputWithRawEncodingSuite(ChannelThroughputBenchmark):
    """Sends unpacked (int based) data to measure send throughput via channel"""
    @timeit
...
if __name__ == '__main__':
    ...
    SendThroughputWithRawEncodingSuite().benchmarkChannels(
