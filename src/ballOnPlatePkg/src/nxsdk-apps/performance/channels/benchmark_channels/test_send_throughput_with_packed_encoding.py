...
"""Benchmarking send throughput on superhost with packed encoding"""
...
class SendThroughputWithPackedEncodingSuite(ChannelThroughputBenchmark):
    """Sends packed data to measure send throughput via channel"""
    @timeit
...
if __name__ == '__main__':
    ...
    SendThroughputWithPackedEncodingSuite().benchmarkChannels(
