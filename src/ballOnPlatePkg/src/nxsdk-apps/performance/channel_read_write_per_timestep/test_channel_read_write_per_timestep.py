...
"""Benchmark channel read write every time step"""
...
class ChannelReadWritePerTimeStepSuite(PerfLoggingHandler):
    """Benchmark channel read write every time step"""

    def setup(self, SKIP=1):
        ...
        guardName = None
        phase = "init"
        initProcess = self.board.createProcess("initProcess", cPath, includeDir,
...
if __name__ == "__main__":
    # Run with SKIP=1
    suite = ChannelReadWritePerTimeStepSuite()
    suite.setup(SKIP=1)
