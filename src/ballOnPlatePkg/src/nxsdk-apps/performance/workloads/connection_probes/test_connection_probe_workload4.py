...
"""Workload to benchmark a network of 200 compartments, 1 connection, all synapse probes"""
...
class WorkloadConnectionProbe4Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 200 compartments, 1 connection, all synapse probes"""
    @timeit
    @memit
...
if __name__ == '__main__':
    WorkloadConnectionProbe4Suite().time_workload()
