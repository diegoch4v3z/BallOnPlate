...
"""Workload to benchmark a network of 200 compartments, 1 connection, delay probe"""
...
class WorkloadConnectionProbe3Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 200 compartments, 1 connection, delay probe"""
    @timeit
    @memit
    def time_workload(self):
        ...
        conn.probe([nx.ProbeParameter.SYNAPSE_DELAY], None)
        net.run(100)
        net.disconnect()


if __name__ == '__main__':
    WorkloadConnectionProbe3Suite().time_workload()
