...
"""Workload to benchmark a network of 200 compartments, 1 connection, tag probe"""
...
class WorkloadConnectionProbe2Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 200 compartments, 1 connection, tag probe"""
    @timeit
    @memit
    def time_workload(self):
        ...
        conn.probe([nx.ProbeParameter.SYNAPSE_TAG], None)
        net.run(100)
        net.disconnect()


if __name__ == '__main__':
    WorkloadConnectionProbe2Suite().time_workload()
