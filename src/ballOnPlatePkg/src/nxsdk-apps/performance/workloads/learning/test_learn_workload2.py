...
"""Workload to benchmark a network of 200 compartments, 100 connections, learning on(1)"""
...
class WorkloadLearn2Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 200 compartments, 100 connections, learning on(1)"""
    @timeit
    @memit
    def time_workload(self):
        ...
        for i in range(0, 100):
            cg1[i].connect(cg2[i], prototype=connProto1)
...
if __name__ == '__main__':
    WorkloadLearn2Suite().time_workload()
