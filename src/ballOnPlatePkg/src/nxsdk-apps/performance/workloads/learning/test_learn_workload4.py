...
"""Workload to benchmark a network of 200 compartments, 10000 connection, learning on(1)"""
...
class WorkloadLearn4Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 200 compartments, 10000 connection, learning on(1)"""
    @timeit
    @memit
...
if __name__ == '__main__':
    WorkloadLearn4Suite().time_workload()
