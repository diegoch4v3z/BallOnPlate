...
"""Workload to benchmark a network of 200 compartments, 1 connection, learning on(1)"""
...
class WorkloadLearn1Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 200 compartments, 1 connection, learning on(1)"""
    @timeit
    @memit
    def time_workload(self):
        ...
        cg1[0].connect(cg2[0], prototype=connProto1)
...
if __name__ == '__main__':
    WorkloadLearn1Suite().time_workload()
