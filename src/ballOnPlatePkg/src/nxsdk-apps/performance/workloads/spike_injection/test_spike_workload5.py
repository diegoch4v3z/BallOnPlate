...
"""Workload to benchmark a network of 100x100 fully connected compartments sending 100*100 to CG1"""
...
class WorkloadSpike5Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 100x100 fully connected compartments sending 100*100 to CG1"""
    @timeit
    @memit
    def time_workload(self):
        ...
        for i in range(0, numPorts):
            spikeGen.addSpikes([i], [[x for x in range(1, 100)]])
...
if __name__ == '__main__':
    WorkloadSpike5Suite().time_workload()
