...
"""Workload to benchmark a network of 100x100 fully connected compartments sending 100*10 to CG1"""
...
class WorkloadSpike2Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 100x100 fully connected compartments sending 100*10 to CG1"""
    @timeit
    @memit
...
if __name__ == '__main__':
    WorkloadSpike2Suite().time_workload()
