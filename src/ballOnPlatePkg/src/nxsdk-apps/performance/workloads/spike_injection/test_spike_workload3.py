...
"""Workload to benchmark a network of 100x100 fully connected compartments sending 100*20 to CG1"""
...
class WorkloadSpike3Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 100x100 fully connected compartments sending 100*20 to CG1"""
    @timeit
    @memit
...
if __name__ == '__main__':
    WorkloadSpike3Suite().time_workload()
