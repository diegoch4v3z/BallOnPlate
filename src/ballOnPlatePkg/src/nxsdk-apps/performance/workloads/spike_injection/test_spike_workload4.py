...
"""Workload to benchmark a network of 100x100 fully connected compartments sending 100*50 to CG1"""
...
class WorkloadSpike4Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 100x100 fully connected compartments sending 100*50 to CG1"""
    @timeit
    @memit
...
if __name__ == '__main__':
    WorkloadSpike4Suite().time_workload()
