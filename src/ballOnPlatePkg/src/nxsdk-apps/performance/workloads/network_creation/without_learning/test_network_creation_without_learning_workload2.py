...
"""Workload to benchmark time for creating 2^12 compartments with 512 connections each"""
...
class WorkloadNetworkCreationTime2Suite(PerfLoggingHandler):
    """Workload to benchmark time for creating 2^12 compartments with 512 connections each"""
...
if __name__ == '__main__':
    WorkloadNetworkCreationTime2Suite().time_workload(numCompartments=2**12,
