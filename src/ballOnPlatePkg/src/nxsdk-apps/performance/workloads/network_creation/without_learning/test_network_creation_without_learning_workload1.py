...
"""Workload to benchmark time for creating 2^10 compartments with 512 connections each"""
...
class WorkloadNetworkCreationTime1Suite(PerfLoggingHandler):
    """Workload to benchmark time for creating 2^10 compartments with 512 connections each"""
...
if __name__ == '__main__':
    WorkloadNetworkCreationTime1Suite().time_workload(numCompartments=2**10,
