...
"""Workload to benchmark time for creating 2^10 compartments with 512 learning enabled connections each"""
...
class WorkloadNetworkCreationWithLearningTime1Suite(PerfLoggingHandler):
    """Workload to benchmark time for creating 2^10 compartments with 512 learning enabled connections each"""
...
if __name__ == '__main__':
    WorkloadNetworkCreationWithLearningTime1Suite().time_workload(numCompartments=2**10,
