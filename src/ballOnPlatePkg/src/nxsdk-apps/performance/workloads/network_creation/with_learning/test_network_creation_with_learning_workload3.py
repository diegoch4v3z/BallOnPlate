...
"""Workload to benchmark time for creating 2^14 compartments with 512 learning enabled connections each"""
...
class WorkloadNetworkCreationWithLearningTime3Suite(PerfLoggingHandler):
    """Workload to benchmark time for creating 2^14 compartments with 512 learning enabled connections each"""
...
if __name__ == '__main__':
    WorkloadNetworkCreationWithLearningTime3Suite().time_workload(numCompartments=2**14,
