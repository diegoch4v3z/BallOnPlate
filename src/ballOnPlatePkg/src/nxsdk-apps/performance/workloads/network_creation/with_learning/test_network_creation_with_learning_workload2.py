...
"""Workload to benchmark time for creating 2^12 compartments with 512 learning enabled connections each"""
...
class WorkloadNetworkCreationWithLearningTime2Suite(PerfLoggingHandler):
    """Workload to benchmark time for creating 2^12 compartments with 512 learning enabled connections each"""
...
if __name__ == '__main__':
    WorkloadNetworkCreationWithLearningTime2Suite().time_workload(numCompartments=2**12,
