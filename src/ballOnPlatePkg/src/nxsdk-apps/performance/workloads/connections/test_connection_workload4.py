...
"""Workload to benchmark a network of 200 compartments, 10000 connections"""
...
class WorkloadConnection4Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 200 compartments, 10000 connections"""
    @timeit
    @memit
...
if __name__ == '__main__':
    WorkloadConnection4Suite().time_workload()
