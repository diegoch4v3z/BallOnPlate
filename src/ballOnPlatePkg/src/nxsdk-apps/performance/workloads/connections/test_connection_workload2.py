...
"""Workload to benchmark a network of 200 compartments, 100 connections"""
...
class WorkloadConnection2Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 200 compartments, 100 connections"""
    @timeit
    @memit
...
if __name__ == '__main__':
    WorkloadConnection2Suite().time_workload()
