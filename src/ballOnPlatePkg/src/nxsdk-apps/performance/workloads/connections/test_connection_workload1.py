...
"""Workload to benchmark a network of 200 compartments, 1 connection"""
...
class WorkloadConnection1Suite(PerfLoggingHandler):
    """Workload to benchmark a network of 200 compartments, 1 connection"""
    @timeit
    @memit
...
if __name__ == '__main__':
    WorkloadConnection1Suite().time_workload()
