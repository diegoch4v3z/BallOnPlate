...
# and thus achieves to compress examples with repeated connectivity structure.
...
def setupNetwork(populationMsgType=32):
    ...
    if populationMsgType == 16:
        ...
        dstCoreId = 4
        dstSynMapId = 0
        n2Core.createPop16Axon(popId, srcCxId, srcRelCxId, dstChipId,
                               dstCoreId, dstSynMapId)
        srcCxId = 1
        srcRelCxId = 1
        n2Core.createPop16Axon(popId, srcCxId, srcRelCxId, dstChipId,
                               dstCoreId, dstSynMapId)
        ...
        n2Core.synapseMap[0].population16MapEntry.configure(
            cxBase=1, atomBits=0)
        ...
        n2Core.synapseMap[1].population16MapEntry.configure(
            cxBase=2, atomBits=0)
        ...
        dstCoreId = 4
        dstSynMapId = 0
        n2Core.createPop32Axon(popId, srcCxId, srcRelCxId, dstChipId,
                               dstCoreId, dstSynMapId)
        srcCxId = 1
        srcRelCxId = 1
        n2Core.createPop32Axon(popId, srcCxId, srcRelCxId, dstChipId,
