...
# -----------------------------------------------------------------------------
# This tutorial illustrates the use of the ISTDP learning rule. The
...
def setupNetwork(net, spikeTimes0, spikeTimes1):
    ...
    plrn = nx.CompartmentPrototype(vThMant=190,
    ...
    # Configure ISTDP learning rule
    # dw: Weight adaptation learning rule (ISTDP).  In general, the learning
    ...
    lr = net.createLearningRule(dw='8*y1*x0-7*x0*y2+8*y0*x1-7*y0*x2',
    ...
    connProto2 = nx.ConnectionPrototype(weight=200, delay=0, enableLearning=1,
                                        learningRule=lr)
...
# scatter plot of ISTDP behavior.
# -----------------------------------------------------------------------------


def createIstdpScatter(spikeTimes0ByC1, spikeTimes1ByC2, conn23PrbSyn):
...
if __name__ == '__main__':
    ...
    # Notice that the Loihi ISTDP learning rule implementation exhibits the
    # typical ISTDP relationship.
    #
    ...
    # "wgtDeltas", "timeDelta", and "deltaTimeStamps" in create IstdpScatter,
    ...
    (timeDelta, weightDeltas) = createIstdpScatter(spikeTimes0,
                                                   spikeTimes1,
                                                   conn23PrbSyn)

    print(weightDeltas.tolist())
    ...
    if haveDisplay:
        ...
        fileName1 = "tutorial_18c_fig1000.png"
        fileName2 = "tutorial_18c_fig1001.png"
