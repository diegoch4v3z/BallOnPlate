...
class ModelParams():
    def __init__(self,
        ...
        """
        self.timestepPerImage = 32
        self.numTrainIterations = 2
        self.imagePresentOffset = 2
        self.maxNumImages = 720
        self.bytesPerImage = 50
        self.firstTimestep = 1
        self.spikeInterval = 8
